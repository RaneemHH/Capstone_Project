        ...
        switch (currentStep) {
            ...
            case 2:
                return {
                    ...
                    description: "أضف وأدر المشاركين في المعرض. يمكنك مراجعة الملخص المالي ودعوة الطلاب والمنظمات للمشاركة.",
            ...
            case 3:
                return {
                    ...
                    description: "راجع الجدول الزمني للمعرض وتوزيع الأكشاك. تأكد من تأكيد جميع التفاصيل قبل البدء.",
                    didYouKnow: "يمكنك البدء بالمعرض بمجرد التأكد من جميع التجهيزات وتوزيع الأماكن."
                };
            case 4:
                return {
                    stepLabel: "الخطوة 4",
                    title: "المعرض نشط",
                    description: "المعرض جارٍ الآن. يمكنك إدارة تسجيلات الطلاب وتسجيل الحضور والغياب بشكل مباشر.",
                    didYouKnow: "تسجيل حضور الطلاب يساعد في قياس نجاح المعرض وتوفير بيانات دقيقة للمشاركة."
                };
            case 5:
                return {
                    stepLabel: "الخطوة 5",
